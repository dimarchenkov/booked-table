...
class CalendarProvider(ABC):
    ...
    def create_event(
        ...
        *,
        ...
        """Create event in external calendar and return (uid, href)."""

    @abstractmethod
    def delete_event(self, *, table_id: int, href: Optional[str], uid: Optional[str]) -> None:
        """Delete event by href or uid."""


class StubCalendarProvider(CalendarProvider):
    """No-op calendar provider for local development."""
    ...
    def create_event(
        ...
        *,
        ...
        return f"stub-{booking_id}", ""

    def delete_event(self, *, table_id: int, href: Optional[str], uid: Optional[str]) -> None:
        return None


class YandexCalDAVCalendarProvider(CalendarProvider):
...
def get_calendar_provider() -> CalendarProvider:
    """Return calendar provider based on settings."""
